...
user in an INI file next to ReTextPortable.exe called ReTextPortable.ini.
...
copy AppNamePortable.ini from this directory to ReTextPortable.ini next to
ReTextPortable.exe. The options in the INI file are as follows:
